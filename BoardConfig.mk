...
# Kernel
  ...
  # toolchain only for cyanogenmod 2.6.32/35 kernel
  TARGET_KERNEL_CUSTOM_TOOLCHAIN := arm-eabi-4.4.3
  # toolchain only for carbon rom 2.6.32/35 kernel
...
# Hardware rendering
  ...
  # only for kernel without sync framework
